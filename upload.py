...
neft_incoming = pd.read_excel('D:\Downloads\MobileNeftPaymentDetailsReport.xls',skiprows=4,usecols=range(1,16))
...
os.remove('D:\Downloads\MobileNeftPaymentDetailsReport.xls')
