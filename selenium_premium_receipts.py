...
driver.get("http://10.200.41.130:8080/NeftPortal/neft/RollIdentifier.do?empNo=44515&empName=.%20BARNEEDHAR%20VIGNESHWAR%20G&offCode=500200&userId=BARNEEDHAR")

select = Select(driver.find_element('name','role'))
select.select_by_visible_text('Approver')

driver.get("http://10.200.41.130:8080/NeftPortal/neft/TransactionDetailsReportByOfficeCode.do?parameter=searchByOfficeCode&param=colreport")


driver.execute_script('''var elts = document.getElementsByClassName("tdval");
